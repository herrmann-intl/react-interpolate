...
var JsxInterpolate = function (_React$Component) {
  _inherits(JsxInterpolate, _React$Component);

  function JsxInterpolate() {
    _classCallCheck(this, JsxInterpolate);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(JsxInterpolate).apply(this, arguments));
  }

  _createClass(JsxInterpolate, [{
    key: 'render',
  ...
  return JsxInterpolate;
}(_react2.default.Component);

JsxInterpolate.propTypes = {
  template: _react2.default.PropTypes.string.isRequired
};
exports.default = JsxInterpolate;


JsxInterpolate.propTypes = { template: _react2.default.PropTypes.string };